...
Secondo Khenchen Thrangu Rinpoche, riconoscere la natura interdipendente dei fenomeni esterni è simile all'idea di relatività. Se siamo in piedi su una collina, la collina su cui ci troviamo è "qui" e la collina che vediamo in lontananza è la collina "laggiù". Ma se andiamo sull'altra collina, la collina su cui ci troviamo ora è la collina "qui" e la collina su cui stavamo prima è la collina "laggiù". Allo stesso modo, le cose che si basano sull'interdipendenza con altri oggetti non hanno una natura intrinseca, ma dipendono sempre dalle circostanze. In altre parole sono costrutti mentali come grande/piccolo, buono/cattivo, chiaro/scuro, ecc.
