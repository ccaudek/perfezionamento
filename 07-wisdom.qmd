...
Secondo Prajñākaramati, "Saṃvṛti è così chiamato perché con esso la comprensione di ciò che è così com'è è nascosta, o occlusa, a causa dell'occlusione dell'essere essenziale... Ignoranza, stupore ed errore sono sinonimi \[di saṃvṛti\]. Poiché l'ignoranza, essendo l'imputazione delle"forme delle cose inesistenti \[a ciò che esiste\], e quindi della natura di occlusione della visione dell'essere inerente, è saṃvṛti". Così, per Prajñākaramati "occultamento" ha la precedenza su "convenzionale" come senso primario di saṃvṛti.

La discussione di Prajñākaramati sul significato di ciò che è "ultimo" (paramārtha) rivela una sottile mescolanza di due temi che erano stati associati a questo termine sin dall'antichità. Da un lato, seguendo una tradizione stabilita negli aspetti analitici del pensiero dell'Abhidharma (cioè, la prima scolastica buddista), è ciò che è in definitiva reale, è ciò che non viene distrutto attraverso una procedura analitica riduttiva. Per il filosofo del V secolo Vasubandhu questo significava che si tratta di due tipi di cose: atomi fisici e atomi fenomenici, o dharma. Per Prajñākaramati come pensatore Madhyamika, tuttavia, l'analisi non può trovare tali punti di conclusione; deve essere perseguita fino a che essa non riveli la contingenza radicale di tutti i fenomeni condizionati, la loro vacuità ultima. Il significato ultimo corrisponde a "l'assenza dell'essere inerente a tutti i dharma, la \[loro intrinseca\] vacuità".

Il tema di un'analisi spinta agli estremi è strettamente associato ad un secondo tema, quello del carattere ultimo del percorso soteriologico: la meta finale è l'"abbandono delle afflizioni". Poiché paramārtha può significare, non solo "significato ultimo" in senso analitico, ma anche paramapuruṣārtha, cioè il "termine più alto dell'uomo", ovvero liberazione (mokṣa).

Nell'interpretazione di Prajñākaramati, dunque, il risultato ultimo dell'analisi dei fenomeni è quello che ne mette in luce la vacuità; d'altra parte, il risultato ultimo, o di maggior valore, dell'attività umana è la liberazione delle afflizioni. La liberazione delle afflizioni, dunque, emerge in parallelo alla comprensione della vacuità dei fenomeni.
...
Per i buddisti indiani, come Śāntideva, la conoscenza non è un fine in se stesso; non è tanto la conoscenza che è in gioco, quanto la conseguente riduzione della sofferenza che si dice derivi da tale conoscenza. Il tipo di conoscenza che consente l'eliminazione della sofferenza si chiama prajñā. Questo termine è spesso tradotto come "saggezza", ma sembra essere più vicino al significato di "intuizione", "conoscenza non discriminante" o "apprensione intuitiva". La prajñā è la "conoscenza/saggezza suprema" che consente di raggiungere in modo diretto il risveglio spirituale (bodhi). Tale conseguimento di "conoscenza/saggezza suprema" è frutto non solo dello studio e della riflessione intellettuale, quanto piuttosto della pratica meditativa.
...
Il percorso del bodhisattva conduce naturalmente ad un autentica cognizione della realtà così come veramente è (yathābhūta), ovvero alla visione della vacuità.
...
> Perché si dice che il dominio dell'intelletto è ciò che è relativo.\
> --- (BCA IX:2)

> Il nostro scopo è qui eliminare la causa del dolore:\
> Il pensiero che i fenomeni abbiano una vera esistenza.

Per Śāntideva, dunque, è la reificazione della realtà, ovvero la convinzione che i fenomeni siano dotati di svabhāva, è la causa della sofferenza. Se consideriamo gli enti (bhava) come reali, cioè dotati di un esistenza indipendente, allora naturalmente finiamo per essere attaccati ad essi, anche se essi non sono altro che nostre proiezioni, reificazioni del flusso in continuo cambiamento della nostra esperienza fenomenica.
...
Secondo Śāntideva, il superamento della reificazione del reale può solo essere ottenuto attraverso la realizzazione della vacuità (śūnyatā), ovvero, con la cessazione del pensiero discorsivo.
...
In altre parole, Śāntideva afferma che non è sufficiente accontentarsi della capacità di entrare in certi stati superiori di coscienza; bisogna anche raggiungere un grado più alto di saggezza (prajñā). Abbiamo visto che prajñā corrisponde alla visione della vacuità, ovvero alla capacità non cadere più vittime dell'abitudine che ci porta ad assegnare un'esistenza intrinseca alle categorie mentali. Nelle parole di Nāgārjuna: "Quando cessa l'ignoranza (avidyā), non sorgono più le formazioni mentali (saṃskāra)" (MMk. 26.11a).
...
Śāntideva afferma un duplice beneficio che deriva da prajñā, ovvero dalla realizzazione della vacuità: in primo luogo, prajñā consente di agire con compassione; in secondo luogo, prajñā consente la rimozione delle contaminazioni emotive e delle oscurazioni mentali. Solo la saggezza della vacuità (prajñā) e i "mezzi abili" (upāya) dei bodhisattva consentono di rimuovere completamente le oscurazioni mentali:
...
> Tale è il frutto che produce la vacuità.\
> --- (BCA IX:52)
...
Dunque, Śāntideva auspica uno stadio iniziale di rinuncia interiore che consenta alla mente di stabilizzarsi. Ottenuto questo stato di stabilizzazione meditativa diventa poi possibile iniziare l'analisi della natura della coscienza, ovvero della vacuità. L'oggetto di tale meditazione è la natura illusoria della pseudo-realtà e delle sue cause:
...
Il Dalai Lama (1975) riprende l'affermazione di Śāntideva secondo cui la realizzazione della vacuità non può essere ottenuta attraverso il pensiero razionale (l'intelletto). Il Dalai Lama sottolinea però che la comprensione della vacuità è un processo a due stadi che, al suo interno, include anche la razionalità del pensiero concettuale. Secondo il Dalai Lama:
...
In maniera parallela, Śāntideva afferma
...
> Allora tutto ciò che essa valuta è falso.\
> Quindi diventa illogico meditare su qualunque degli oggetti della conoscenza,\
> Anche sulla vacuità.\
> --- (BCA IX:138)
