...
Il capitolo sull'*anātman* nella sezione precedente e il @sec-non-dualism della presente sezione hanno introdotto la dottrina buddhista del non-sé: l'idea che ciò che chiamiamo "io" sia una costruzione convenzionale, non un'entità sostanziale. Questo capitolo approfondisce quella prospettiva da un'angolazione diversa: **come l'esperienza ordinaria costruisce, momento per momento, l'illusione di un sé separato**.
...
Questo processo avviene continuamente, in modo così rapido e automatico da risultare invisibile. Tuttavia, le sue conseguenze sono enormi: **ogni momento di appropriazione rafforza l'illusione di un sé separato** e genera le condizioni per la sofferenza [@analayo2004sattipatthana].
