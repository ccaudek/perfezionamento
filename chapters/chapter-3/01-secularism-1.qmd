...
L’interesse scientifico per la compassione (*compassion*) ha favorito, soprattutto dagli anni 2000 in poi, la nascita di numerosi protocolli di intervento, spesso organizzati come corsi manualizzati o come moduli psicoterapeutici. Tra i programmi più influenti (pur con differenze rilevanti per obiettivi, popolazioni e cornici teoriche) figurano:
...
Questi interventi condividono un presupposto operativo: la compassione non è solo un tratto stabile (“essere compassionevoli”), ma una **capacità allenabile** con esercizi ripetuti, riflessioni guidate e pratiche contemplative. Tuttavia, ciò che viene addestrato come “compassione” in senso psicologico non coincide necessariamente con *karuṇā* come è intesa nelle fonti mahāyāna: la differenza riguarda soprattutto **finalità**, **antropologia implicita** e **cornice metafisica** (tema che guiderà l’intera Parte III).

> **Nota di precisione:** la pratica tibetana del **Tonglen** compare in modo esplicito in alcuni programmi (in particolare CCT e, con varianti, in contesti affini), ma **non** è un elemento “fondamentale” o universalmente presente in tutti gli interventi contemporanei. In questa sezione Tonglen è rilevante perché funziona da cartina di tornasole: rende visibile quanto la tradizione indo-tibetana leghi la compassione a una dinamica di decentramento del sé, spesso più radicale di quanto i contesti clinici adottino.

## Contesto: scienza, secolarismo e buddhismo

La formazione secolare alla compassione emerge nel quadro più ampio del dialogo tra buddhismo e scienza, e della trasformazione moderna delle pratiche contemplative in Occidente. Come già evidenziato nella Parte II, nel contesto buddhista la meditazione non è una tecnica neutrale, ma un addestramento incorporato in un progetto etico-soteriologico: riduzione delle afflizioni (*kleśa*), trasformazione della visione del sé (*anātman*), e — nel Mahāyāna — integrazione tra saggezza (*prajñā*) e compassione (*karuṇā*).
...
Qui emerge una prima differenza di fondo rispetto alla cornice mahāyāna discussa nella Parte I–II: nelle tradizioni indo-tibetane classiche la pratica mira spesso a decentrarsi dall’auto-preoccupazione (*self-cherishing*), mentre in contesti clinici moderni l’obiettivo può includere la ricostruzione di una base affettiva sicura del sé. Non si tratta necessariamente di contraddizione, ma di **diverso problema di partenza** e diversa antropologia implicita — tema che diventerà centrale nel capitolo successivo.

## Similarità e differenze tra CCT e addestramento tradizionale alla compassione

### Continuità significative

1. **Allenabilità della compassione**
...
Riprendendo la tripartizione discussa nella Parte I (costruttivo / decostruttivo / cognitivo-analitico), il CCT lavora soprattutto su:
...
Qui la differenza diventa particolarmente rilevante per la Parte III.
...
Questa divergenza non implica che l’auto-compassione sia “sbagliata”, ma suggerisce che essa operi su una configurazione culturale e psicologica specifica. Nel capitolo successivo chiariremo perché, dal punto di vista mahāyāna, l’auto-compassione in senso moderno può apparire concettualmente instabile o persino ossimorica — e in che modo, tuttavia, potrebbe funzionare come *upāya* in contesti clinici.
...
Questa analisi porta alla domanda che apre il capitolo successivo: **che cosa accade quando la compassione viene esplicitamente diretta verso il sé**, diventando auto-compassione, in contesti dove il sé è già iper-riflessivo e narrativamente saturo? È qui che la tensione tra antropologie implicite — e la questione dell’auto-oggettificazione — diventa decisiva.
